...
export function ArticulosTable({ data }: { data: any[] }) {
  ...
  // Valores para los inputs (Temporales)
    ...
    <div className="space-y-4">
      ...
      <div className="sticky top-[-16px] z-30 bg-slate-50/95 backdrop-blur-sm pb-4 pt-2 -mx-2 px-2 border-b mb-6">
        <div className="flex flex-col md:flex-row justify-between items-end gap-4">
          ...
          {/* Panel de Dólar y FOB con Botón Modificar */}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-28 h-10 pl-7 font-bold text-blue-600 border-slate-100 bg-slate-50/50"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-24 h-10 pl-7 font-bold text-amber-600 border-slate-100 bg-slate-50/50"
                />
              </div>
            </div>
            ...
            {filteredData.map((item) => {
              ...
              return (
                <TableRow key={item.id} className="hover:bg-blue-50/30 transition-colors border-slate-100">
                  ...
                  {/* PRECIO BASE FORMATEADO: $105.880,08 */}
      ...
      {/* MODAL DE EDICIÓN / CREACIÓN (DIALOG) */}
      ...
      <div className="text-[10px] text-slate-400 italic text-right pr-4 pb-10">
        * Calculando con Dólar a ${activeDolar.toLocaleString('es-AR')} y FOB x{activeFob.toFixed(2)}. (Presiona Modificar para aplicar cambios)
      </div>
    </div>
  );
}
