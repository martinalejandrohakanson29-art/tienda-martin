...
const CATEGORY_SEO_MAP: Record<string, CategoryInfo> = {
  cilindros: {
    title: "Cilindros y Kits de Cilindrada para Motos | Revolución Motos",
  ...
  levas: {
    title: "Árboles de Levas de Competición y Calle | Revolución Motos",
  ...
  carburadores: {
    title: "Carburadores Cortina Plana y de Competición para Motos | Revolución Motos",
  ...
  escapes: {
    title: "Escapes Deportivos y de Competición para Motos | Revolución Motos",
  ...
  combos: {
    title: "Kits de Potenciación y Combos en Oferta | Revolución Motos",
  ...
  "tableros-digitales": {
    title: "Tableros Digitales e Instrumentales para Motos | Revolución Motos",
...
export function getCategorySeoData(categoryName: string): CategoryInfo {
  ...
  const defaultInfo: CategoryInfo = {
    title: `${categoryName} para Motos | Revolución Motos`,
